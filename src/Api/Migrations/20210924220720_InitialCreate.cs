        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCountry = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ShippingCity = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ShippingAddress = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderDetails_Orders_OrderRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_OrderRecordId",
                table: "OrderDetails",
